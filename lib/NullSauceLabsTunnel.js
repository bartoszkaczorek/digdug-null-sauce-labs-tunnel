...
function NullSauceLabsTunnel() {
	Tunnel.apply(this, arguments);
}

var _super = Tunnel.prototype;
NullSauceLabsTunnel.prototype = util.mixin(Object.create(_super), /** @lends module:digdug/NullTunnel */ {
	auth: '',
	isDownloaded: true,
	download: success,
	start: function () {
...
module.exports = NullSauceLabsTunnel;
